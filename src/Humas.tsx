      ...
      <div className="min-h-screen bg-white/65">
        ...
        <section className="relative flex min-h-[calc(100vh-72px)] w-full items-center justify-center overflow-hidden px-4 py-16 sm:px-6 lg:px-8">
          <div className="absolute inset-0 z-0 overflow-hidden">
            <img
              src="/images/humas/fullhumas.webp"
        ...
        <section className="mx-auto max-w-7xl px-5 py-12 pb-28 lg:px-8 lg:py-20">
          <div className="text-center" data-aos="fade-up">
            ...
            <p className="mx-auto mt-3 max-w-xl text-xs font-medium leading-relaxed text-slate-600 sm:text-sm">
              Langkah nyata HUMAS dalam membangun sinergi, memperluas relasi, dan mendekatkan BEM kepada seluruh civitas akademika.
            </p>
          ...
          <div className="mt-12 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            {[
              { no: "01", nama: "SAKSI", sub: "Sinergi Aksi Kolaborasi", collab: null },
              { no: "02", nama: "Delegasi Eksternal", sub: null, collab: null },
              { no: "03", nama: "POLSRI Goes to School / Goes to Desa", sub: null, collab: null },
              { no: "04", nama: "KENAL", sub: "Konten Edukasi dan Informasi Seputar POLSRI", collab: "Collab · Medinfo" },
              { no: "05", nama: "BEM Peduli", sub: null, collab: "Collab · Adkesma" },
              { no: "06", nama: "LINGKAR", sub: "Lingkar Kolaborasi dan Relasi", collab: null },
              { no: "07", nama: "Delegasi Internal", sub: null, collab: null },
              { no: "08", nama: "Public Speaking Class", sub: null, collab: null },
            ].map((proker, idx) => (
              <div
                key={idx}
                data-aos="fade-up"
