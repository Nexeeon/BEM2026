        ...
        <section className="mx-auto max-w-7xl px-5 py-12 pb-28 lg:px-8 lg:py-20">
          <div className="text-center" data-aos="fade-up">
            ...
            <p className="mx-auto mt-3 max-w-xl text-xs font-medium leading-relaxed text-slate-600 sm:text-sm">
              Inisiatif ADKESMA dalam memperjuangkan hak, kesejahteraan, dan perlindungan seluruh mahasiswa POLSRI.
            </p>
          ...
          <div className="mt-12 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {[
              { no: "01", nama: "GForm Perlindungan Mahasiswa SIGAP", sub: "Sistem Pengaduan Aman & Profesional", collab: null },
              { no: "02", nama: "Narahubung Layanan Konseling", sub: null, collab: null },
              { no: "03", nama: "GForm Aspirasi Mahasiswa/i", sub: "Bisik Kampus", collab: null },
              { no: "04", nama: "Seribu Rupiah untuk Bersama", sub: null, collab: null },
              { no: "05", nama: "Kesma Care", sub: null, collab: null },
              { no: "06", nama: "Narahubung PPKPT", sub: null, collab: null },
            ].map((proker, idx) => (
              <div
                key={idx}
                data-aos="fade-up"
