        ...
        <section className="mx-auto max-w-7xl px-5 py-12 pb-28 lg:px-8 lg:py-20">
          <div className="text-center" data-aos="fade-up">
            ...
            <p className="mx-auto mt-3 max-w-xl text-xs font-medium leading-relaxed text-slate-600 sm:text-sm">
              Gerak strategis KASTRAT dalam mengkaji isu, mengawal aspirasi, dan menggerakkan mahasiswa secara kritis dan terukur.
            </p>
          ...
          <div className="mt-12 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {[
              { no: "01", nama: "Memori Kolektif", sub: null, collab: "Collab · Medinfo" },
              { no: "02", nama: "Radar Isu", sub: null, collab: null },
              { no: "03", nama: "Kastrat Pedia", sub: null, collab: null },
              { no: "04", nama: "Kastrat Bootcamp", sub: null, collab: null },
              { no: "05", nama: "Simpul Gerak", sub: null, collab: null },
              { no: "06", nama: "Garda Juang", sub: null, collab: null },
            ].map((proker, idx) => (
              <div
                key={idx}
                data-aos="fade-up"
